            ...
            try:
                ...
                if report.deactivated:
                    messages.info(
                        request,
                        (
                            f'{report.deactivated} товарів «{supplier.name}» не було у файлі — '
                            'їх знято з продажу (залишок 0, на сайті не показуються). '
                            'Товари інших постачальників не змінювались. '
