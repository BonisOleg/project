...
# Порядок коренів у меню (як на siker.ua).
# Трактори/СТО/Сертифікат видимі лише якщо в YML є товари в наявності.
ROOT_SORT: dict[str, int] = {
    ...
    EXT_ZOO: 80,
    EXT_SALE: 90,
    '23326954': 100,  # Трактори
    '23326871': 110,  # Обладнання для СТО
    '23326898': 120,  # Сертифікат
    '23326938': 130,  # Акумуляторні батареї
}
